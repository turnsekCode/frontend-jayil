...
const OvaloCollection = () => {
  ...
  const applyFilter = () => {
    ...
    const selectedSubcategory = "Óvalo";
    productsCopy = productsCopy.filter(item =>
      ...
      <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-[110px]'>
        ...
        <div className='flex-1'>
          <div className='flex justify-between text-base sm:text-2xl mb-4 gap-2'>
            <Title text1={'COLECCIÓN DE'} text2={'ÓVALO'} />
          ...
          <div >
            <p className='mb-10 text-gray-500 text-sm px-2'>
              Los pendientes Óvalos son perfectos para el uso diario gracias a su diseño ligero y cómodo. Su versatilidad los convierte en el accesorio ideal para cualquier ocasión, desde una jornada laboral hasta una salida casual. Realza tu belleza natural y destaca con la elegancia discreta de estos pendientes artesanales que combinan a la perfección con tu día a día.
            </p>
          </div>
...
export default OvaloCollection