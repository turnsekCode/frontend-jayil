...
const KarinaCollection = () => {
  ...
  const applyFilter = () => {
    ...
    const selectedSubcategory = "Karina";
    productsCopy = productsCopy.filter(item =>
  ...
  return (
    <>
      <Helmet>
        <title>Pendientes Karina Exclusivos - Joyería Artesanal Hecha a Mano</title>
        <meta name='description' content='Enamórate de los pendientes Karina, joyas únicas hechas a mano con diseño exclusivo. Perfectos para destacar tu estilo romántico y sofisticado. Joyería artesanal que combina elegancia y originalidad. ¡Adquiérelos hoy!' />
        ...
        <link rel='canonical' href='https://www.jayil.es/collection/pendientes/karina' />
      </Helmet>
      ...
      <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-[110px]'>
        ...
        <div className='flex-1'>
          <div className='flex justify-between text-base sm:text-2xl mb-4 gap-2'>
            <Title text1={'COLECCIÓN DE'} text2={'KARINA'} />
          ...
          <div >
            <p className='mb-10 text-gray-500 text-sm px-2'>
              ...
              Añade un toque de elegancia y estilo moderno a tu colección de joyas con estos deslumbrantes pendientes Karina.
            </p>
          </div>
...
export default KarinaCollection