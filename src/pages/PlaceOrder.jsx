        ...
        <div className='mt-8'>
          ...
          <div className='flex flex-col gap-2 mt-2 text-sm'>
            {cartData.map((item, index) => {
              ...
              return (
                <div key={index} className='flex justify-between gap-10'>
                  <p title={productData?.name}>{productData?.name.slice(0, 40) + '...'} <strong>X{item?.quantity}</strong></p>
                  <p>{productData?.price.toFixed(2)}{currency}</p>
                </div>
              );
            })}
            ...
            {discount > 0 ? <div className='flex justify-between'>
              <p>Descuento</p>
              <p>- {discount.toFixed(2)}{currency} </p>
            </div> : null}
            <hr />
            <div className='flex justify-between'>
              <p>Total</p>
          ...
          <div className='mt-4'>
            ...
            {discount > 0 && <p className='text-green-500 mt-2'>Cupón aplicado: {discount.toFixed(2)}{currency}</p>}
