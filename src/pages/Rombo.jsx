...
const RomboCollection = () => {
  ...
  const applyFilter = () => {
    ...
    const selectedSubcategory = "Rombo";
    productsCopy = productsCopy.filter(item =>
  ...
  return (
    <>
      <Helmet>
        <title>Pendientes Rombo Exclusivos - Joyería Artesanal en Acero Inoxidable</title>
        <meta name='description' content='Luce los exclusivos pendientes Rombo, diseño artesanal único con un toque moderno. Fornituras de acero inoxidable, elegancia duradera y estilo inigualable. Descubre la joyería que resalta tu personalidad. ¡Compra ahora!' />
      ...
      <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-[110px]'>
        ...
        <div className='flex-1'>
          <div className='flex justify-between text-base sm:text-2xl mb-4 gap-2'>
            <Title text1={'COLECCIÓN DE'} text2={'ROMBO'} />
          ...
          <div >
            <p className='mb-10 text-gray-500 text-sm px-2'>
              Los pendientes Rombos son perfectos para el uso diario gracias a su diseño ligero y cómodo. Su versatilidad los convierte en el accesorio ideal para cualquier ocasión, desde una jornada laboral hasta una salida casual. Realza tu belleza natural y destaca con la elegancia discreta de estos pendientes artesanales que combinan a la perfección con tu día a día.
            </p>
          </div>
...
export default RomboCollection