        ...
        <div className='flex-1'>
          ...
          <div >
            <p className='mb-10 text-gray-500 text-sm px-2'>
              Los pendientes Colección floral son perfectos para el uso diario gracias a su diseño ligero y cómodo. Su versatilidad los convierte en el accesorio ideal para cualquier ocasión, desde una jornada laboral hasta una salida casual. Realza tu belleza natural y destaca con la elegancia discreta de estos pendientes artesanales que combinan a la perfección con tu día a día.
            </p>
          </div>
